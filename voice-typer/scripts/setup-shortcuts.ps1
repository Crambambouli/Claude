# Erstellt Desktop-Verknüpfung und optionalen Windows-Autostart für Voice Typer
...
$shortcut.Description      = "Voice Typer – F8 zum Diktieren"
$shortcut.Save()
...
if ($answer -eq 'j') {
    ...
    $startupLink = Join-Path $startupDir "Voice Typer.lnk"
...
Write-Host "`nFertig! Voice Typer jetzt über Desktop-Verknüpfung starten." -ForegroundColor Cyan
